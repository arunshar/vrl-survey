...
This document, entitled \textbf{`Summary of Differences'}, details the differences from the previous version of ``The Rise of Verbal Reinforcement Learning: A Survey''. The differences are highlighted in \red{red}. All changes were made by \textbf{direct replacement}: the superseded text was removed and the new or updated text appears in red; no strikethrough is used. Page and line references correspond to the marked, line-numbered revised manuscript.
...
\section{Section 1: Definition of VRL (Page 2, lines 70--104)}
...
\section{Section 1: Prior Surveys and Contributions (Page 3, lines 142--184)}
...
\section{Section 2: Taxonomy (Pages 3--4, lines 229--247, and new Table 1)}
...
\section{Section 3.4: Reward Code Generation (Page 5, lines 368--372)}
...
\section{Section 4.4: Experiential Memory (Page 7, lines 467--472)}
...
\section{Section 4.5: Search Subsection (Page 7, lines 487--493)}
...
\section{Section 5.4: Preference Shaping (Page 8, lines 611--627)}
...
\section{Section 6: Discussion (Pages 8--10)}
...
\paragraph{Updated Version:} \red{A new subsection ``Algorithmic Interactions and Practitioner Guidance'' (Section 6.1, pages 8--9, lines 630--661) pairs each feedback form with its optimization family (generated reward functions with online policy gradients; pairwise judgments with offline preference objectives; filtered or feedback-conditioned text with supervised fine-tuning; step-level judgments with process reward models) and names the consequences inside the decision problem: reward mis-specification and hacking, state information loss and aliasing, and exploration under LLM priors, with a pointer to the new decision table (Appendix B).} In Section 6.2 (page 9, lines 674--684): \red{a recommendation to report feedback quality and feedback utilization separately, citing RewardBench, ProcessBench, and Feedback Friction.} In Section 6.5 (page 10): \red{a named research agenda: sample-efficiency conditions under which verbal feedback beats scalar reward; optimality and convergence under language-shaped rewards; temporal credit assignment from free-form critiques; provenance and robustness of feedback channels; and standardized, separate evaluation of feedback quality and utilization.}

\section{Limitations (Page 10, lines 813--831)}
